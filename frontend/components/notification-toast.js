...
function NotificationToast({ notification, onClose }) {
  const { id: notificationId, type, title, message, amount, fromName, fromAddress } = notification
  ...
  const handlePayNow = async () => {
    ...
    try {
      ...
      if (result.success) {
        // Notification API disabled for performance
        ...
        showNotification({
          ...
          message: `Sent ${amount} SOL to ${fromName}`,
          amount: amount,
        })
